...
/**
 * Servlet that request a new OAuth request token and redirects the user the authorization page
 * 
 * @author Jeff Douglas
 */
...
public class LoginServlet extends HttpServlet {
    ...
    protected static final Logger log = Logger.getLogger(LoginServlet.class.getName());
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        log.info("OauthSettings.CONSUMER_KEY: " + OauthSettings.CONSUMER_KEY);
        log.info("OauthSettings.CONSUMER_SECRET: " + OauthSettings.CONSUMER_SECRET);
        ...
        String response = OauthHelperUtils.getRequestToken(accessor, OauthSettings.URL_REQUEST_TOKEN,
                OauthSettings.URL_CALLBACK);
        ...
        try {
            String authUrl = OauthHelperUtils.buildAuthorizationUrl(accessor, OauthSettings.URL_AUTHORIZATION);
